...
type FlightServiceClient interface {
	DetailFlight(ctx context.Context, in *FlightRequest, opts ...grpc.CallOption) (*FlightResponse, error)
}
...
func (c *flightServiceClient) DetailFlight(ctx context.Context, in *FlightRequest, opts ...grpc.CallOption) (*FlightResponse, error) {
	out := new(FlightResponse)
	err := c.cc.Invoke(ctx, "/proto.FlightService/DetailFlight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FlightServiceServer interface {
	DetailFlight(context.Context, *FlightRequest) (*FlightResponse, error)
...
func (UnimplementedFlightServiceServer) DetailFlight(context.Context, *FlightRequest) (*FlightResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DetailFlight not implemented")
}
...
func _FlightService_DetailFlight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlightRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlightServiceServer).DetailFlight(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.FlightService/DetailFlight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlightServiceServer).DetailFlight(ctx, req.(*FlightRequest))
	}
...
var FlightService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DetailFlight",
			Handler:    _FlightService_DetailFlight_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "common/grpc/proto/flight.proto",
}
